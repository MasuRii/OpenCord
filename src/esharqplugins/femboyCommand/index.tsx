...
export default definePlugin({
    name: "FemboyCommand",
    description: "Sends a random femboy picture via /femboy. Uses 7 APIs with random order and automatic fallback. ⚠️ NSFW. Use at your own risk — Esharq disclaims all liability.",
    authors: [EquicordDevs.LOSTSTR, { name: "x2b", id: 996137713432530976n }],
    commands: [
        {
            name: "femboy",
            description: t("أرسل صورة عشوائية في الدردشة", "Send a random femboy picture in chat"),
            ...
            execute: async (args, ctx) => {
                ...
                if (!result) {
                    sendBotMessage(ctx.channel.id, {
                        content: t("❌ تعذّر جلب الصورة — فشلت جميع الواجهات. حاول بعد لحظات.", "❌ Couldn't fetch a femboy picture — all APIs failed. Try again in a moment.")
                    });
                    return;
                }
