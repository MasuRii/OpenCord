...
export default definePlugin({
    ...
    commands: [
        {
            name: "define",
            description: t("ابحث عن تعريف كلمة", "Look up the definition of a word"),
            ...
            execute: async (opts, ctx) => {
                ...
                try {
                    ...
                    sendBotMessage(ctx.channel.id, { content: t("تعذّر الوصول إلى القاموس الآن.", "Couldn't reach the dictionary right now.") });
                }
            }
        }
    ]
